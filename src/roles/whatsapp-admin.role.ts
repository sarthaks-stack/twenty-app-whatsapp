...
export default defineRole({
  ...
  objectPermissions: [
    readWrite(OBJ_THREAD, '3f7d2b8e-1a95-4c60-8e43-9b2f6d1a5c78'),
    ...
    readWrite(OBJ_CONSENT_EVENT, 'a4f8c1d6-9b25-4370-8e64-2f7b5a9d1c38'),
    {
    ...
    {
      universalIdentifier: 'c7f1a4b8-2e69-4d03-8517-9b6e3a5c1f74',
      objectUniversalIdentifier: OBJ_WEBHOOK_EVENT,
      canReadObjectRecords: true,
      canUpdateObjectRecords: true,
      canSoftDeleteObjectRecords: true,
